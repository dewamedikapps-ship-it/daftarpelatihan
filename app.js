...
function TabPendaftar({
  ...
  function unduhCsv() {
    ...
    const head = ["No registrasi", "Tanggal daftar", "Nama", "NIK", "Email", "WhatsApp", "Instansi", "Kota/kabupaten", "Profesi", "Akun Plataran Sehat/SATUSEHAT SDMK", "Pelatihan", "Jadwal", "Harga awal", "Kode member", "Persen Member Benefit", "Member Benefit", "Total", "Jenis pendaftaran", "Dibayar", "Sisa pelunasan", "Minta invoice", "Instansi penagihan", "Asal link", "Status", "Catatan"];
    const tglRingkas = v => {
      if (!v) return "";
      const d = new Date(v);
    ...
    r.instansi, r.kota || "", r.profesi, r.plataran, r.pelatihan ? r.pelatihan.judul : "", r.pelatihan ? rentang(r.pelatihan.tanggal_mulai, r.pelatihan.tanggal_selesai) : "", Number(r.harga_awal) || 0, r.voucher_kode || "", Number(r.persen) || 0, Number(r.diskon) || 0, Number(r.total) || 0, r.tipe_bayar === "booking" ? "Booking seat" : "Bayar penuh", Number(r.jumlah_bayar != null ? r.jumlah_bayar : r.total) || 0, Number(r.sisa_bayar) || 0, r.minta_invoice ? "Ya" : "Tidak", r.invoice_instansi || "", r.kampanye || "", statusTeks[r.status] || r.status, r.catatan || ""]);
    const sel = v => {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    ukuran: 13,
    kelas: "dm-svg-samar"
  }), r.kota) : null), /*#__PURE__*/React.createElement("td", null, r.pelatihan ? r.pelatihan.judul : "—", r.pelatihan && r.pelatihan.tanggal_mulai ? /*#__PURE__*/React.createElement("p", {
    className: "dm-hint"
