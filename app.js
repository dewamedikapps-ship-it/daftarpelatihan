...
function BackOffice({
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "dm-subtab"
      ...
      : [["pendaftar", "Pendaftar"], ["jadwal", "Jadwal"], ["voucher", "Voucher"], ["testimoni", "Testimoni"], ["kerjasama", "Kerja Sama"], ["prospek", "Pelihat Harga"], ["karir", "Karir"], ["fasilitas", "Fasilitas"], ["invoice", "Invoice"], ["linkkelas", "Link Kelas"], ["akun", "Akun Pengguna"], ["setelan", "Pengaturan"], ["keamanan", "Keamanan"]]).map(([k, l]) => /*#__PURE__*/React.createElement("button", {
    key: k,
...
function TabPendaftar({
  ...
  async function muat() {
    const {
      data,
      error
    } = await SB.from("pendaftaran").select("*, pelatihan(judul, jenis, tanggal_mulai, tanggal_selesai, wa_grup)").order("dibuat", {
      ascending: false
    });
  ...
  const tampil = baris.filter(r => filter === "semua" ? true : r.status === filter).filter(r => cari ? (r.nama + r.email + r.nomor + r.nik).toLowerCase().includes(cari.toLowerCase()) : true);
  const nilai = baris.filter(r => r.status === "terverifikasi").reduce((a, b) => a + Number(b.total), 0);
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "dm-mono"
  }, baris.length)), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", null, "Perlu diperiksa"), /*#__PURE__*/React.createElement("b", {
    className: "dm-mono"
  }, baris.filter(r => r.status === "menunggu").length)), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", null, "Terverifikasi"), /*#__PURE__*/React.createElement("b", {
    className: "dm-mono"
  }, baris.filter(r => r.status === "terverifikasi").length)), peran === "diklat" ? null : /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", null, "Nilai terverifikasi"), /*#__PURE__*/React.createElement("b", {
    className: "dm-mono"
    ...
    value: "ditolak"
  }, "Perlu diperbaiki")), peran === "diklat" ? null : /*#__PURE__*/React.createElement("button", {
    className: "dm-btn-line",
    onClick: unduhCsv
  }, /*#__PURE__*/React.createElement(Ikon, {
    nama: "papan",
    ...
    className: "dm-mono"
  }, r.nomor), /*#__PURE__*/React.createElement("td", null, /*#__PURE__*/React.createElement("b", null, r.nama), r.minta_invoice ? /*#__PURE__*/React.createElement("span", {
  ...
  }, "Kembalikan ke menunggu")), detail.status === "terverifikasi" || detail.status === "ditolak" ? /*#__PURE__*/React.createElement("div", {
    className: "dm-kabari"
...
function LembarInvoice({
  ...
  }, /*#__PURE__*/React.createElement("b", null, "Terbilang:"), " ", /*#__PURE__*/React.createElement("i", null, terbilang(total))), /*#__PURE__*/React.createElement("p", {
    className: "dm-inv-paragraf"
...
function TabInvoice({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    return /*#__PURE__*/React.createElement("tr", {
      ...
      status: v.status === "lunas" ? "terverifikasi" : v.status === "batal" ? "ditolak" : "menunggu"
    })), /*#__PURE__*/React.createElement("td", {
      className: "dm-aksi"
    }, /*#__PURE__*/React.createElement("button", {
      className: "dm-btn-ghost",
    ...
    value: "batal"
  }, "Batal")))), /*#__PURE__*/React.createElement("p", {
    className: "dm-kelompok-judul",
    style: {
      marginTop: 18
    }
    ...
    className: "dm-hint"
  }, "Klik Simpan PDF, lalu pada jendela cetak pilih Tujuan: ", /*#__PURE__*/React.createElement("b", null, "Save as PDF"), ", ukuran kertas A4, dan margin Default.")), /*#__PURE__*/React.createElement("div", {
    className: "dm-row"
  }, /*#__PURE__*/React.createElement("button", {
    className: "dm-btn",
    onClick: () => window.print()
  }, "Simpan PDF"), /*#__PURE__*/React.createElement("button", {
    className: "dm-btn-line",
